#!/usr/bin/env python3
"""Score WakeBenchmark results.csv — openWakeWord recall / false-accept report.
...
def main():
    ...
    out = []
    out.append("=" * 72)
    out.append("OPENWAKEWORD BENCHMARK  (synthetic TTS, file injection — model behaviour, not acoustics)")
    out.append("=" * 72)
