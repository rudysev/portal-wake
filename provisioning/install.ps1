...
function Start-WakeService {
  ...
  # Wait until a wake detector is actually listening before telling the user to speak — the
  # model + grammar take a few seconds to load, and a "hey jarvis" said before that can be
  # missed. The service logs "wake detector ready (...)" once it's listening; count existing
